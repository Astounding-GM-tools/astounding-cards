...
{#if showDuplicateDialog}
	<div class="modal-overlay">
		<div class="modal">
			...
			<label>
				New Preset Name:
				<input type="text" bind:value={duplicateName} placeholder="Enter preset name..." />
			</label>

			<div class="modal-actions">
				<button class="btn btn-secondary" onclick={cancelDuplicate}>Cancel</button>
				<button class="btn btn-primary" onclick={confirmDuplicate} disabled={!duplicateName.trim()}>
					Duplicate
				</button>
			</div>
		</div>
