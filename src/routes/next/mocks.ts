...
export const mockCardOne = {
    ...
    stats: [
        ...
        { id: 'population', name: 'Population', value: 50, tracked: true, isPublic: false, description: 'Bandits and brigands, all looking for the adventurers.' },
        { id: 'area', name: 'Area', value: '2 miles', tracked: false, isPublic: true },
        { id: 'resource', name: 'Alert', value: 10, tracked: true, isPublic: false, description: 'Failed stealth check? Tick a box. When full, sound the alarm.' }
    ]
};
...
export const mockCardTwo = {
    ...
    stats: [
        { id: 'value', name: 'Value', value: '1,200', tracked: false, isPublic: false, description: 'Discerning collectors would drool all over the Ethereal Compass; a pawnshop might offer 10% of the value of this "decorative, but non-functional compass".' },
        ...
        { id: 'mana', name: 'Charges', value: 14, tracked: true, isPublic: false, description: '1 charge per turn when active. May be charged.' }
    ]
};
