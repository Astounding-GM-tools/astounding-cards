<script lang="ts">
	...
	function updateConflict(
		index: number,
		resolution: MetaConflict['resolution'],
		customValue?: any
	) {
...
<div class="meta-conflicts">
	<div class="conflicts-header">
		...
		<p class="conflicts-description">Choose how to resolve differences in deck metadata:</p>
	</div>
		...
		{#each metaConflicts as conflict, index}
			...
			>
				...
				<div class="values-comparison">
					...
					<div
						class="value-option"
						class:selected={conflict.resolution === METADATA_RESOLUTION.KEEP_EXISTING}
					>
					...
					<div
						class="value-option"
						class:selected={conflict.resolution === METADATA_RESOLUTION.USE_IMPORTED}
					>
						<div class="option-header">
							<input
					...
					<div class="option-header">
						<input
							...
							onchange={() =>
								updateConflict(
									index,
									METADATA_RESOLUTION.CUSTOM,
									conflict.customValue || conflict.existingValue
								)}
						/>
						...
						<div class="custom-input">
							...
							{:else}
								<input
									...
									oninput={(e) =>
										updateConflict(index, METADATA_RESOLUTION.CUSTOM, e.currentTarget.value)}
								/>
							{/if}
						</div>
					{/if}
