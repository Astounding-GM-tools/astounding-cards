...
<div class="merge-tool">
	...
	<div class="actions">
		<button class="action-button secondary" onclick={onCancel}> Cancel Import </button>

		<button class="action-button primary" onclick={handleResolve} disabled={!canResolve}>
