<script lang="ts">
	...
	import {
		...
		estimateImportSize
	} from '$lib/next/utils/jsonImporter.js';
...
<div class="json-import-dialog">
	...
	<div class="dialog-content">
			...
			<div class="import-preview">
				...
				{#if needsMerge}
					<div class="merge-warning">
						...
						<p>
							A deck with this ID already exists. You'll need to choose how to handle conflicts.
						</p>
					</div>
				{/if}
				...
				<div class="import-actions">
					...
					<button class="action-button" onclick={clearImport}> Import Different Deck </button>
				</div>
			</div>
		{/if}
		...
		<div class="import-info">
			<p>
				<strong>Supported formats:</strong> JSON files exported from this application, AI-generated decks,
				or compatible deck formats.
			</p>
		</div>
	</div>
</div>
