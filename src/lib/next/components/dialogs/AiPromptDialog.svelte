<script lang="ts">
	...
	const characteristics = [
		'traits and stats suitable for IKEA furniture',
		'odd references to tropical birds',
		'extensive rhyming in all text content',
		'mysterious connections to cheese varieties',
		'stats based on likelihood to survive a zombie apocalypse',
		'descriptions written like Shakespearean sonnets',
		'traits that would make them excellent dance partners',
		'stats measuring their compatibility with houseplants',
		'abilities related to competitive sandwich making',
		'mysterious powers involving forgotten board games',
		'stats for navigating corporate office politics',
		'traits based on their favorite extinct animals',
		'powers related to predicting weather using only socks',
		'abilities involving interpretive dance battles'
	];
...
<div class="ai-prompt-dialog">
	...
	<div class="dialog-content">
		...
		<div class="config-section">
			...
			<p class="description">
				Describe the deck you want and the AI will create a complete deck with detailed cards,
				traits, and stats.
			</p>
			...
			{#if showApiKeyRow}
				...
				<div class="api-key-info">
					<p class="security-note-simple">
						🔒 According to Google's ToS, you shouldnt share API keys, and that is sensible so we <em
							>promise</em
						>
						we won't copy yours! We will send the request directly to Google AI Studio. We're working
						on a paid feature so you won't need to enter your key like this - check back later some time
						if you don't trust us (we're astoundingly trustworthy, but we get it).
	...
	<div class="dialog-footer">
		<button type="button" class="footer-button secondary" onclick={reset}> 🔄 Start Over </button>
