<script lang="ts">
	...
	async function processPromptWithGemini() {
		...
		try {
			...
			if (result.success && result.result) {
				...
				toasts.success(
					'🎯 Prompt processed successfully! This version should avoid content filters.'
				);
			} else {
	...
	async function copyPrompt() {
		...
		try {
			...
			toasts.success(
				`✅ ${processedPrompt ? 'Smart processed' : 'AI image'} prompt copied! Paste it into ChatGPT, DALL-E, or your favorite AI image generator`
			);
		} catch (err) {
	...
	<div class="dialog-content">
		...
		<div class="api-key-section">
			<div class="section-header">
				...
				<button class="toggle-button" onclick={() => (showApiKeySection = !showApiKeySection)}>
			...
			{#if showApiKeySection}
				<div class="api-key-content">
					<p class="api-key-description">
						Use <strong>your own</strong> Google AI Studio API key to automatically process prompts and
						avoid content filtering issues. Your API key stays in your browser - we never see it!
					</p>
					...
					<div class="security-note">
						🔒 <strong>Your privacy:</strong> API key is stored only in your browser. All requests go
						directly to Google - never through our servers.
					</div>
				</div>
			{/if}
		</div>
		...
		<div class="prompt-section">
			<div class="prompt-header">
				...
				<div class="prompt-header-actions">
					...
					{/if}
					<button class="regenerate-button" onclick={regeneratePrompt} disabled={isGenerating}>
			...
			{#if processedPrompt}
				<div class="processed-notice">
					...
					<button class="show-original-button" onclick={() => (processedPrompt = '')}>
						Show Original
					</button>
				</div>
			{/if}
			...
			<div class="prompt-actions">
				<button class="copy-button primary" onclick={copyPrompt} disabled={isGenerating || !prompt}>
		...
		<div class="instructions">
			...
			<div class="tips">
				...
				<ul>
					...
					<li>
						For consistent character appearance, mention specific details like hair color, clothing,
						etc.
					</li>
