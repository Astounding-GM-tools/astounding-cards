...
<header class="app-header">
	<div class="header-top">
		...
		<div class="header-right">
			...
			{#if deck}
				<button class="action-button" onclick={handleAddCard} disabled={isLoading}>
					➕ Add Card
				</button>

				<button class="action-button" onclick={handleShareDeck} disabled={isLoading}>
					🔗 Share
				</button>
	...
	{#if nextDevStore.isDevMode}
		<div class="header-controls">
			<div class="dev-controls">
				<button class="dev-button" onclick={handleLoadSample} disabled={isLoading}>
					Load Sample
				</button>
				<button class="dev-button danger" onclick={handleClearDatabase} disabled={isLoading}>
					Clear DB
				</button>
			</div>
		</div>
