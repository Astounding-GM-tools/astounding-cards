...
<div class="mechanics-editor">
			...
			<div class="mechanic-item">
				<div class="mechanic-header">
					<div class="type-selector">
						<span class="type-icon" title={getTypeName(mechanic.type)}
							>{getTypeIcon(mechanic.type)}</span
						>
				...
				<div class="mechanic-fields">
					...
					<div class="field checkbox-field">
						<label class="checkbox-label">
							<input type="checkbox" bind:checked={mechanic.tracked} />
	...
	<div class="actions">
		<button type="button" class="add-btn" onclick={addMechanic}> + Add Mechanic </button>
	</div>
</div>
