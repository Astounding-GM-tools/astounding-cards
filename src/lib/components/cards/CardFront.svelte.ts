 ...
 */
export function getImageButtonText(hasImage: boolean, isUpdating: boolean): string {
	if (isUpdating) {
		return 'Updating...';
	}
 ...
 */
export function updateImageState(state: ImageState, updates: Partial<ImageState>): ImageState {
