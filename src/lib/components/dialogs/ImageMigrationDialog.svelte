<script lang="ts">
	...
	async function handleSave() {
		if (
			!state.selectedCard ||
			!canSaveMigration(state.urlInput, state.loading, state.optimizedBlob)
		)
			return;
...
<dialog bind:this={dialogElement} class="migration-dialog" onclose={handleClose}>
						...
						<div class="image-comparison">
							<div class="image-column">
								...
								<div class="image-container">
									<div
										class="image-preview"
										style:background-image={state.selectedCard.imageBlob
											? `url(${URL.createObjectURL(state.selectedCard.imageBlob)})`
											: 'none'}
									>
