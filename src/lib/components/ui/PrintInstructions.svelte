...
<dialog bind:this={dialogElement} class="print-dialog">
	<div class="dialog-header">
		<h2>🖨️ Print Instructions</h2>
		<button class="close-button" onclick={() => dialogElement && closeDialog(dialogElement)}>
			×
		</button>
	</div>
	<div class="dialog-content">
		...
		<ul>
			...
			<li>
				For duplex (double-sided) printers:
				<ul>
			...
			<li>
				...
				<ul>
					...
					<li>
						Place printed sheets back in printer:
						<ul>
