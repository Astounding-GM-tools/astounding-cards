 ...
 */
async function processFileImage(file: File, cardSize: CardSize): Promise<ImageProcessingResult> {
	try {
 ...
 */
async function processUrlImage(url: string, cardSize: CardSize): Promise<ImageProcessingResult> {
	try {
