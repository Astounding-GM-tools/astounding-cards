...
import type { TemplateDialogState, TemplateDialogAction } from './StatblockTemplateDialog.svelte.ts';
...
describe('StatblockTemplateDialog Integration Tests', () => {
  ...
  it('should work with actual StatblockTemplate and StatblockVocabulary types', async () => {
    const { mapCardTypeToCategory, formatStatWithVocabulary } = await import('./StatblockTemplateDialog.svelte.ts');
