<script lang="ts">
	...
	const {
		vocabulary = configToSimpleVocabulary(getDefaultConfig()),
		title = 'Customize Statblock Vocabulary'
	}: Props = $props();
	...
	const hasChanges = $derived(hasVocabularyChanged(originalVocabulary, workingVocabulary));
...
<div class="vocabulary-editor">
	...
	<div class="editor-content">
		...
		<div class="section">
			...
			<div class="custom-stats">
				...
				<button class="add-stat-button" onclick={addCustomStat}> + Add Custom Stat </button>
			</div>
		</div>
	...
	<div class="editor-actions">
		...
		<div class="main-actions">
			...
			<button class="primary" onclick={handleSave} disabled={!hasChanges}> Save Vocabulary </button>
		</div>
	</div>
</div>
