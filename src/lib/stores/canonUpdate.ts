...
export async function canonUpdateDeck(
	updates: Partial<Deck['meta']>,
...
export async function canonUpdateCard(
	cardId: string,
...
export async function canonUpdateCards(
	updates: Array<{ cardId: string; updates: Partial<Card> }>,
	loadingFields: string[] = [],
	loadingMessage?: string,
	successMessage?: string
): Promise<boolean> {
...
export async function canonCopyCards(
	cardIds: string[],
...
export async function canonDeleteCards(
	cardIds: string[],
	loadingFields: string[] = [],
	loadingMessage?: string,
	successMessage?: string
...
export async function canonDeleteDeck(
	deckId: string,
	loadingFields: string[] = [],
	loadingMessage?: string,
	successMessage?: string
