...
test.describe('Preview Mode', () => {
  ...
  test('should toggle card front/back in preview', async ({ page, context }) => {
    ...
    const firstCardFrontBtn = newPage.locator('.card-wrapper').first().locator('button:has-text("Front")');
    const firstCardBackBtn = newPage.locator('.card-wrapper').first().locator('button:has-text("Back")');
